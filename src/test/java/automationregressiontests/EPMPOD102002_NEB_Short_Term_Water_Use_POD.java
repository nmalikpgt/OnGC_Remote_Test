...
public class EPMPOD102002_NEB_Short_Term_Water_Use_POD {
    @Test

    public static void EPMPOD102002_NEB_ShortTerm_WaterUse_POD() {
        ...
        Short_Term_Water_Use_POD_Overview.Proposed_Completion_Date_Custmoize(399);
        ...
        Short_Term_Water_Use_POD_Overview.Year_Two_Volume_lake("123456");
        ...
        Short_Term_Water_Use_POD_Overview.Year_One_Volume_lake("123");
        Short_Term_Water_Use_POD_Overview.Year_Two_Volume_lake("123");
        ...
        Short_Term_Water_Use_POD_Overview.Year_Two_Volume_Stream("123456");
        ...
        Short_Term_Water_Use_POD_Overview.Year_Two_Volume_Stream("123");
        ...
        Short_Term_Water_Use_POD_Overview.Year_One_Volume_Stream("123");
        Short_Term_Water_Use_POD_Overview.Year_Two_Volume_Stream("123");
        ...
        Short_Term_Water_Use_POD_Overview.Year_Two_Volume_Water("12345");
