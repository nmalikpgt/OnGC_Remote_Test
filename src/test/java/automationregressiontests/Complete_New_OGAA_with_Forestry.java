...
public class Complete_New_OGAA_with_Forestry {


    @Test(groups = "Separate")

    public static void New_OGAA_With_Forestry() throws SQLException, ClassNotFoundException {
        ...
        Create_Application.NewOGAA.Activites.All_Activies();
        ...
        Spatial_Data_Submission.Upload_Shapefiles_For_OGAA();
...
//        Facility.Facility_overview_Upload_Files.Project_Description_Attachment();
//        Facility.Facility_overview_Upload_Files.Piping_Instrument_Diagram_Attachment();
//        Facility.Facility_overview_Upload_Files.Gathering_System_Schematic_Attachment();
//        Facility.Facility_overview_Upload_Files.Process_Flow_Diagram_Attachment();
//        Facility.Facility_overview_Upload_Files.Plot_Plan_Attachment();
        EPM.Click.Save();
        EPM.Verify.Progress_Message();
        Facility.Click.Facility_Details();
        Facility.Facility_Type();
        Facility.Oil_Gas_Field_Name();
        Facility.Facility_DETAILS_Specifications.FAC("1", "3", "99", "99999", "9999999", "999", "999999", "");
        Facility.Emissions_Air_Details.All_Information("237", "23789", "237", "Yes");
        Facility.Click.Facility_Equipment_Details();
        Facility.Facility_DETAILS_Specifications.Facility_Equipment_DETAILS("12", "237", "12", "");
...
//FN_Consultation_Review.Referral_Package_Summary.Circulation_Method.Online();
        ...
        Crd_Conditions_Advisory.Click.Advisory_Guidance.Add_Standard_Advisory_Guidance_Condition();
        Crd_Conditions_Advisory.Click.Advisory_Guidance.Add_Custom_Advisory_Guidance_Condition();
        Crd_Conditions_Advisory.Click.Forest_District_Table();
...
//        Crd_Conditions_Advisory.Click.Advisory_Guidance.Add_Custom_Advisory_Guidance_Condition();
 //       Crd_Conditions_Advisory.Click.Advisory_SDM_Edit_Highlited();
        ...
        SDM_Review_And_Determination.High_Risk("Yes");
        ...
        SDM_Review_And_Determination.Click.Attachments();
