...
public class Pipeline_Engineering_Review {
    ...
    public static class Application_Activities {
        public static class Set_Activity_Recommendation {
            public static void Recommend() {
                    ...
                    WebDriverWait wait = new WebDriverWait(Browser.driver, 80);
                    Crd_Conditions_Advisory.Click.Scrolldown();
                    Crd_Conditions_Advisory.Java_script_executor(wait.until(ExpectedConditions.presenceOfElementLocated(By.id("reviewSlctdefReviewTypeCode0"))));
                    Browser.Sleep(Browser.Mill_Sec());
    ...
    public static class Click {
        ...
        public static void Pipeline_Engineering_Checklist() {
           Browser.Sleep(Browser.Mill_Sec());
            WebDriverWait wait = new WebDriverWait(Browser.driver, 80);
                Crd_Conditions_Advisory.Click.Scrolldown();
