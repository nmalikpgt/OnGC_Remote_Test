...
public class Hydrology {
    ...
    public static class Click {
        public static void Task_Comment(String EnterNo) {
            ...
            WebDriverWait wait = new WebDriverWait(Browser.driver, 80);
                Crd_Conditions_Advisory.Click.Scrolldown();
            wait.until(ExpectedConditions.elementToBeClickable(By.id("editTaskCommentLnkId"))).click();
            Browser.Sleep(Browser.Mill_Sec());
            wait.until(ExpectedConditions.presenceOfElementLocated(By.id("taskCommentTxtId"))).sendKeys("Test");
            Browser.Sleep(Browser.Mill_Sec());
        ...
        public static void Hydrology_Checklist() {
            Browser.Sleep(Browser.Mill_Sec());
            WebDriverWait wait = new WebDriverWait(Browser.driver, 80);
                Crd_Conditions_Advisory.Click.Scrolldown();
