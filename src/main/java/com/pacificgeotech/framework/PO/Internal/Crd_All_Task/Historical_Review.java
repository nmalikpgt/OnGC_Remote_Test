...
public class Historical_Review {


    public static void Application_Activity() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"reviewSlct00\"]/button/span[3]"))).click();
       Browser.Sleep(Browser.Mill_Sec());
        wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("Accept"))).click();
    ...
    public static class Click {
        ...
        public static void bHistorical_Facility_Checklist() {
           Browser.Sleep(Browser.Mill_Sec());
            WebDriverWait wait = new WebDriverWait(Browser.driver, 80);
                Crd_Conditions_Advisory.Click.Scrolldown();
        ...
        public static void Withdraw_Application() {
           ...
           Browser.Sleep(Browser.Mill_Sec());
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//textarea[@ng-model='formData.comment']"))).sendKeys("Test123....");
           Browser.Sleep(Browser.Mill_Sec());
