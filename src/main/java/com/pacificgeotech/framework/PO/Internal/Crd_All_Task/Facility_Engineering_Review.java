...
public class Facility_Engineering_Review {


    public static class Facility_Review_Details {
            public static void All_Activities() {
               Browser.Sleep(Browser.Mill_Sec());
                ...
                wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@ng-change=\"unsavedChangesPrompt()\"]")));
                List<WebElement> compllie = Browser.driver.findElements(By.xpath("//input[@ng-change=\"unsavedChangesPrompt()\"]"));
    ...
    public static class Click {
        ...
        public static void Facility__Engineering_Checklist() {
           Browser.Sleep(Browser.Mill_Sec());
            WebDriverWait wait = new WebDriverWait(Browser.driver, 80);
                Crd_Conditions_Advisory.Click.Scrolldown();
